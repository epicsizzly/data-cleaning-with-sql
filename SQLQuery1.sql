...
--GO
EXEC xp_cmdshell 'sqlcmd -S DESKTOP-QUR4BA6\SQLEXPRESS -d practice -E -s"," -W -Q "SELECT * FROM practice.dbo.NashvilleHousing" -o "H:\Data Science Work\Data science Projects\data analytics\HousingdataCleaned1.csv"'
